...
import com.zgy.repository.BorrowRepository;
...
public class BorrowRepositoryImpl implements BorrowRepository {
    ...
    public List<Borrow> findAllByReaderId(Integer id,Integer index,Integer limit) {
        Connection connection = JDBCTools.getConnection();
        String sql = "select br.id,r.name,r.tel,r.cardid,b.name,b.author,b.publish,br.borrowtime,br.returntime,br.state from borrow as br,book as b ,reader as r where readerid=? and b.id = br.bookid and r.id = br.readerid limit ?,?";
...
//                int brId = resultSet.getInt(1);
//                String rName = resultSet.getString(2);
//                String tel = resultSet.getString(3);
//                String cardId = resultSet.getString(4);
//                String bookName = resultSet.getString(5);
//                String author = resultSet.getString(6);
//                String publish = resultSet.getString(7);
//                String borrowTime = resultSet.getString(8);
//                String returnTime = resultSet.getString(9);
//                //封装
//                Book book =new Book(bookName,author,publish);
//                Reader reader = new Reader(rName,tel,cardId);
//                Borrow borrow = new Borrow(brId,book,reader,borrowTime,returnTime);
//                list.add(borrow);

                list.add(new Borrow(resultSet.getInt(1),
                        new Book(resultSet.getString(5),resultSet.getString(6),resultSet.getString(7)),
                        new Reader(resultSet.getString(2),resultSet.getString(3),resultSet.getString(4)),
    ...
    public int count(Integer readerid) {
        Connection connection = JDBCTools.getConnection();
        String sql = "select count(*) from borrow as br,book as b ,reader as r where readerid=? and b.id = br.bookid and r.id = br.readerid";
        PreparedStatement statement = null;
        ResultSet resultSet = null;
        int count = 0;
        try {
    ...
    public List<Borrow> findAllByState(Integer state,Integer index,Integer limit) {
        Connection connection = JDBCTools.getConnection();
        String sql = "select br.id,r.name,r.tel,r.cardid,b.name,b.author,b.publish,br.borrowtime,br.returntime,br.state from borrow as br,book as b ,reader as r where state=? and b.id = br.bookid and r.id = br.readerid limit ?,?";
        PreparedStatement statement = null;
        ResultSet resultSet = null;
        List<Borrow> list = new ArrayList<>();
        try {
    ...
    public int countByState(Integer state) {
        Connection connection = JDBCTools.getConnection();
        String sql = "select count(*) from borrow as br,book as b ,reader as r where state =? and b.id = br.bookid and r.id = br.readerid";
        PreparedStatement statement = null;
        ResultSet resultSet = null;
        int count = 0;
        try {
